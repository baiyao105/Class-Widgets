...
class Ui_Theme(object):
    def setupUi(self, Form):
        ...
        self.progressBar.setGeometry(QRect(20, 80, 131, 6))
        ...
        self.progressBar.setVal(75.000000000000000)
        self.activity_countdown_title = QLabel(Form)
        self.activity_countdown_title.setObjectName(u"activity_countdown_title")
        self.activity_countdown_title.setGeometry(QRect(10, 10, 151, 41))
        font = QFont()
        font.setFamilies([u"Microsoft YaHei UI"])
        font.setPointSize(13)
        font.setBold(True)
        self.activity_countdown_title.setFont(font)
        self.activity_countdown_title.setStyleSheet(u"color: rgba(255, 255, 255, 150);\n"
"font-weight: bold;")
        ...
        self.activity_countdown.setGeometry(QRect(20, 30, 131, 61))
        font1 = QFont()
...
"font-weight: bold")
        ...
        self.backgnd.setGeometry(QRect(10, 10, 150, 81))
