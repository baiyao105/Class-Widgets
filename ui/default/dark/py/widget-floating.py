...
"border-radius: 8px")
        ...
        self.label.setStyleSheet(u"background-color: rgba(255, 255, 255, 100);\n"
"border-radius: 2px")
...
"font-weight: bold")
        ...
        sizePolicy1.setHeightForWidth(self.activity_countdown.sizePolicy().hasHeightForWidth())
        self.activity_countdown.setSizePolicy(sizePolicy1)
        font1 = QFont()
        font1.setFamilies([u"Microsoft YaHei UI"])
        font1.setPointSize(14)
        font1.setBold(True)
        self.activity_countdown.setFont(font1)
        self.activity_countdown.setStyleSheet(u"color: rgba(255, 255, 255, 150);\n"
"font-weight: bold;")
