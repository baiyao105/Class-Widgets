...
class Ui_Theme(object):
    def setupUi(self, Form):
        ...
        self.backgnd.setStyleSheet(u"background-color: rgba(245, 245, 255, 245);\n"
"border-radius: 38px")
        ...
        self.subtitle_label.setStyleSheet(u"color: rgba(0, 0, 0, 90);\n"
...
"font-weight: bold;")
        ...
        self.action_name.setStyleSheet(u"color: rgba(37, 37, 37, 255);\n"
"background-color: rgba(0,0,0,0);\n"
"font-weight: bold")
