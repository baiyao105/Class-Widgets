...
class Ui_Theme(object):
    def setupUi(self, Form):
        ...
        self.date_text.setGeometry(QRect(20, 20, 180, 31))
        font = QFont()
...
"font-weight: bold;")
        ...
        self.day_text.setGeometry(QRect(30, 40, 170, 51))
        font1 = QFont()
...
"font-weight: bold")
        ...
        self.backgnd.setGeometry(QRect(10, 10, 210, 91))
        self.backgnd.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:1, y2:0, stop:0 rgba(203, 239, 249, 255), stop:1 rgba(255, 255, 255, 255));\n"
"border-radius: 8px")
