...
"font-weight: bold")
        ...
        self.backgnd.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:0, y2:0, stop:0 rgba(203, 239, 249, 255), stop:1 rgba(255, 255, 255, 255));\n"
"border-radius: 8px")
        self.img = QLabel(Form)
        self.img.setObjectName(u"img")
        self.img.setGeometry(QRect(180, 10, 91, 91))
