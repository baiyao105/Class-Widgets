...
class CSES_Converter:
    ...
    def load_parser(self) -> str | cses.CSESParser:
    ...
    def convert_to_cw(self) -> dict | bool:
        """
    ...
    def convert_to_cses(self, cw_data: dict | None = None, cw_path: str = './') -> bool:
        """
        ...
        """
        def convert(schedules: dict, type_: str = 'odd') -> None:
        ...
        def check_subjects(schedule: dict) -> list[str]:  # 检查课表是否有未正式设定的科目
            unset_subjects = []
